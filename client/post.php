...
<div class="container">
    <div class="row">
        ...
        <form style="width: 100%" method="post" action="../server/post-edit.php">
...
">
            ...
            <div class="form-group row">
                <div class="col-md-9">
                    <input type="hidden" name="edit_post" value="<?php echo $posts[0]['id'];?>">
                    <input class="btn btn-primary mr-4" type="submit" name="edit" value="Редагувати">
                    <input type="hidden" name="delete_post" value="<?php echo $posts[0]['id'];?>">
                    <input class="btn btn-danger" type="submit" name="delete" value="Видалити">
                </div>
                <div class="col-md-3">
                    <?php
